...
import type {ky as kyInterface} from '../source/types/ky';
import {createHttpTestServer, HttpServerOptions, parseRawBody, withPage} from './helpers';
...
const createEsmTestServer = async (options?: HttpServerOptions) => {
	...
	server.use('/lib', express.static(LIB_DIR));
	return server;
};
