...
import {Input, InternalOptions, Options, Hooks, NormalizedOptions, ResponsePromise} from '../types/index.js';
import {
	mergeHeaders,
	deepMerge,
	delay,
...
export class Ky {
	...
	_calculateRetryDelay(error: Error) {
		this._retryCount++;
	...
	/* istanbul ignore next */
	_stream(response: Response, onDownloadProgress: Options['onDownloadProgress']) {
